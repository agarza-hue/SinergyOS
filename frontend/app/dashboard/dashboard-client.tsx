      ...
      <div className="border-b border-white/8 bg-[#171717] sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={async()=>{ await fetch('/sinergy/api/auth',{method:'DELETE'}); window.location.href='/sinergy/login' }}
              title="Cerrar sesión"
              className="p-1.5 text-white/20 hover:text-red-400 transition-colors rounded-md hover:bg-red-400/10">
